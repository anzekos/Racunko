...
import { fetchCustomers, type Customer, type Invoice } from "@/lib/database"
                ...
                {!showPreview ? (
                  <>
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <h1 className="text-2xl font-semibold text-foreground">Generiranje računov</h1>
                    ...
                    <InvoiceForm customers={customers} onInvoiceCreate={handleInvoiceCreate} loading={loading} />
                  </>
                ) : (
                  <>
                    <div className="flex items-center justify-between mb-6">
