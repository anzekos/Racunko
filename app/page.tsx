...
import { Search, Filter, X, ArrowUpDown, Home, ArrowLeft } from "lucide-react"
...
export default function CustomersPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Upravljanje s strankami</h1>
          <p className="text-gray-600 mt-2">Dodajajte, urejajte in upravljajte podatke o strankah</p>
        </div>
        <Link href="/">
      ...
      <Card>
        ...
        <CardContent>
          <Tabs defaultValue="basic" className="w-full">
            ...
            {/* ... ostali tab contenti ostanejo nespremenjeni ... */}
